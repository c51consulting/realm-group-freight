...
export const metadata: Metadata = {
  ...
  description: 'Post a new agricultural material listing.',
};
    ...
    <div className="page-container max-w-3xl">
      ...
      <div className="page-header">
        ...
        <p className="page-subtitle">
          List your agricultural materials for sale, or post a buy request.
        </p>
      </div>

      {/*
        TODO: Convert to a Client Component with react-hook-form or native form actions.
        Wire up to createListing() from lib/api.ts.
      */}
      <form className="space-y-8" action="#" method="POST">
        ...
        <section className="card p-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <label
                key={value}
                className="card p-4 cursor-pointer hover:border-brand-400 transition-colors has-[:checked]:border-brand-500 has-[:checked]:bg-brand-50"
              >
                <input type="radio" name="type" value={value} className="sr-only" />
        ...
        <section className="card p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                type="text"
                placeholder="e.g. Lucerne, Oaten, Barley…"
                className="input"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <input
              ...
              type="text"
              required
              placeholder="e.g. Premium Lucerne Hay — 8×4 bales, 500kg avg"
              className="input"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              name="description"
              rows={4}
              placeholder="Describe the material, condition, harvest date, storage method…"
        ...
        <section className="card p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select id="pricingType" name="pricingType" required className="input">
            ...
            <div>
              <label htmlFor="estimatedWeightPerUnit" className="label">
        ...
        <section className="card p-6 space-y-4">
          ...
          <div className="space-y-3">
            {Object.entries(QUALITY_LEVEL_LABELS).map(([value, label]) => (
              <label
                key={value}
                className="flex items-start gap-3 p-3 rounded-lg border border-gray-200 cursor-pointer hover:border-brand-400 transition-colors has-[:checked]:border-brand-500 has-[:checked]:bg-brand-50"
              >
                <input
                  type="radio"
                  name="qualityLevel"
                  value={value}
                  className="mt-0.5"
                  defaultChecked={value === 'basic'}
                />
                <div>
                  <p className="font-medium text-sm text-gray-900">{label}</p>
                  <p className="text-xs text-gray-500 mt-0.5">
                    {QUALITY_LEVEL_DESCRIPTIONS[value as keyof typeof QUALITY_LEVEL_DESCRIPTIONS]}
                  </p>
                </div>
              </label>
            ))}
        ...
        <section className="card p-6 space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            />
            <label htmlFor="freightIncluded" className="text-sm text-gray-700">
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              className="rounded border-gray-300 text-brand-500 focus:ring-brand-500"
            />
            <label htmlFor="loadingAvailable" className="text-sm text-gray-700">
